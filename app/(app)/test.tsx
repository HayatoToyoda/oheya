...
export default class App extends React.Component<{}, State> {
  ...
  _maybeRenderUploadingOverlay = (): JSX.Element | null => {
  ...
  _maybeRenderImage = (): JSX.Element | null => {
    const { image } = this.state;
    if (!image) {
      return null;
    }
  ...
  _handleImagePicked = async (pickerResult: ImagePicker.ImagePickerResult): Promise<void> => {
    try {
...
async function uploadImageAsync(uri: string | undefined): Promise<string> {
